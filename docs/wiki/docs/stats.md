...
MCHockey continuously collects stats of your players. You can display them in game via PlaceHolderApi compatible placeholders on the placeholders page.

This page deals with sharing stats and game results as a website and on Discord.

## MCPlayerStats Setup

MCHockey ships an integration of [https://mcplayerstats.com/](https://mcplayerstats.com/) which is a service to host websites. The service is included
...
2. Toggle a game
    ...
    ```
    /mchockey toggle <game>
    ```

3. Play a game.

    Observe that you automatically receive a link at the end of a MCHockey game. Click that link to see the produced website.
...
2. Open the stats definition of your game under ``plugins\MCHockey\stats\templates\``. It will be named ``game1_page.yml`` or similar.
